...
export default function Sidebar() {
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex w-64 bg-white border-r border-gray-200 flex-col justify-between px-4 shadow-lg h-screen">
        ...
        <div>
          ...
          <nav className="flex flex-col gap-2">
            ...
            {/* Add Transaction triggers modal */}
            <button type="button" onClick={() => setModalOpen(true)} className="flex items-center gap-3 px-3 py-2 rounded-lg hover:bg-violet-50 transition w-full text-left">
            ...
            {navItems.map((item, idx) => {
              ...
              if (item.name === "Add Transaction") {
                return (
                  ...
                  >
                    <div className="flex items-center justify-center w-12 h-12 bg-[#E9FE52] rounded-lg">
      ...
      <ManualAddModal open={modalOpen} onClose={() => setModalOpen(false)} />
    </>
  );
}
